...
class VideoThread:
    ...
    def run(self):
        ...
        print("Second recording in progress")
...
duration = 30 # amount of time for ascent and deployment recording [s]
session = 180 # limiting amount of time of recording after launch [s]
...
# Waiting for acceleration to start recording
