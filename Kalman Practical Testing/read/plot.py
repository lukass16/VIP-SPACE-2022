...
data = pd.read_csv("KALMAN10.TXT",sep = ',')
...
plt.legend()
plt.show()
plt.savefig("pos.png", dpi=1000)

plt.figure(figsize=(8,6))
plt.plot(t, v, color="c", label = "Kalman velocity [m/s]")
plt.legend()
#plt.show()
plt.savefig("vel.png", dpi=1000)
...
plt.legend()
#plt.show()
plt.savefig("kgain.png", dpi=1000)

plt.figure(figsize=(8,6))
plt.plot(t, u, color="y", label = "Kalman Gain - Uncertainty")
plt.legend()
#plt.show()
plt.savefig("uncert.png", dpi=1000)
